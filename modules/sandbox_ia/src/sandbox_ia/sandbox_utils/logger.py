...
def get_logger(*args, **kwargs):
    """
    Retourne le logger du module sandbox
    
    Returns:
        Logger: Instance du logger sandbox
    """
    return _get_logger(
...
def setup_logger(
    ...
    **kwargs
    ...
    """
    Configure le logger du module sandbox
...
if __name__ == "__main__":
    # Tester le logger sandbox
    logger = get_logger()
    logger.print("Démarrage de sandbox")
