...
MODULE_NAME = "simulateur_attaque"
STRUCTURED = True  
LOG_DIR: Optional[Union[str, Path]] = None
def get_logger(*args, **kwargs):
    """
    Retourne le logger du module simulateur_attaque
    
    Returns:
        Logger: Instance du logger simulateur_attaque
    """
    return _get_logger(
...
def setup_logger(
    ...
    **kwargs
    ...
    """
    Configure le logger du module simulateur_attaque
...
if __name__ == "__main__":
    # Tester le logger simulateur_attaque
    logger = get_logger()
    logger.print("Démarrage de simulateur_attaque")
    logger.info("simulateur_attaque initialisé")
