...
MODULE_NAME = "anti_phishing"
STRUCTURED = True  
LOG_DIR: Optional[Union[str, Path]] = None
def get_logger(*args, **kwargs):
    """
    Retourne le logger du module anti_phishing
    
    Returns:
        Logger: Instance du logger anti_phishing
    """
    return _get_logger(
...
def setup_logger(
    ...
    **kwargs
    ...
    """
    Configure le logger du module anti_phishing
...
if __name__ == "__main__":
    # Tester le logger anti_phishing
    logger = get_logger()
    logger.print("Démarrage de anti_phishing")
    logger.info("anti_phishing initialisé")
