...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug 17 07:03:30 2026
...
class Config:
    ...
    def __init__(self):
        ...
        self.MAX_WORKERS: int = 150
        self.FUZZ_TIMEOUT: float = 60 * 60 * 2
...
class Fuzzer:
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._executor = concurrent.futures.ThreadPoolExecutor(
            max_workers=self.config.MAX_WORKERS + 10, 
    ...
    def select_vuln_to_test(self, limit_vuln: int | list[str] = None) -> List[Dict[str, Any]]:
        """
    ...
    async def test(self, urls: List[str] = None, use_cache: bool = True) -> None:
        ...
        try:
            ...
            for url in urls:
                ...
                self.config.FUZZ_TIMEOUT = 60 * 60 * 2
                # print(self.config.FUZZ_TIMEOUT)
